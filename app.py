...
# =========================
    ...
    if st.session_state.page is None:
        ...
        st.write(f"**Cash Left Yesterday:** {summary['cash_left_yesterday']}")
        st.write(f"**Cash Left Today:** {summary['cash_left_today']}")
        st.write(f"**Net Sales (calculated):** {summary['net_sales']}")
        st.write(f"**System Sales (POS):** {summary['system_sales']}")
        st.write(f"**Difference:** {summary['difference']}")
